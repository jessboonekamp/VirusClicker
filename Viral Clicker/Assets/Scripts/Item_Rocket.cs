...
public class Item_Rocket: MonoBehaviour{
    ...
    public GameObject rocketOne;
    public GameObject rocketTwo;
    public GameObject rocketThree;
    ...
    public void OnClick(){
        if (GlobalVirus.peopleInfected >= cost)
        {
            ...
            Rocket.hasUpgrade = true;
        }
        rocketOne.SetActive(true);
        rocketTwo.SetActive(true);
        rocketThree.SetActive(true);
